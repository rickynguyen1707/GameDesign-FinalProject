...
public class PlayerMovement : MonoBehaviour
{
    ...
    {
        Vector2 originLeft = new Vector2(pos.x - 0.35f + 0.1f, pos.y - 0.6f );
        Vector2 originMiddle = new Vector2(pos.x, pos.y - 0.6f);
        Vector2 originRight = new Vector2(pos.x + 0.35f - 0.1f, pos.y - 0.6f);
    ...
    {
        Vector2 originLeft = new Vector2(pos.x - 0.3f + 0.2f, pos.y + 0.5f);
        Vector2 originMiddle = new Vector2(pos.x, pos.y + 0.5f);
        Vector2 originRight = new Vector2(pos.x + 0.3f - 0.2f, pos.y + 0.5f);
